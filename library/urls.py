...
urlpatterns = [
    ...
    path(
        "authors/<int:pk>/update/", AuthorUpdateAPIView.as_view(), name="author-update"
    ),
    path(
        "authors/<int:pk>/delete/", AuthorDestroyAPIView.as_view(), name="author-delete"
    ),
    # Books
    ...
    path(
        "issues/<int:pk>/", BookIssueRetrieveAPIView.as_view(), name="issues-retrieve"
    ),
    path(
        "issues/<int:pk>/update/",
        BookIssueUpdateAPIView.as_view(),
        name="issues-update",
    ),
    path(
